...
while b !=  'quit':
    ...
    if weather !=  'rain':
        ...
        if dry > 4:
            weather = 'dry'
    if weather == 'rain':
        happy = random.randrange(-5, 10)
        hppy = happiness - happy
        happiness = hppy
    else:
        happy = random.randrange(-10, 1)
        hppy = happiness - happy
        happiness = hppy
    newaples = random.randrange(7) #new apples determined
    newcrrt = random.randrange(5) #new carrots determined
    reaples = newaples + apples
    recrrt = carrot + newcrrt
    apples = reaples
    carrot = recrrt
    newmicro = random.randrange(2) #new microwaves determined
    remicro = microwave + newmicro
    microwave = remicro
    newbur = random.randrange(2) #new burgers determined
    rebur = burger + newbur
    burger = rebur
    tpricemicro = random.uniform(59.99, 119.99) #carrots priced
    xpricemicro = tpricemicro * 100
    ymicro = int(xpricemicro)
    zmicro = float(ymicro)
    pricemicro = zmicro / 100
    tpricebur = random.uniform(3.69, 4.99) #carrots priced
        ...
        while walking != 'go home':
            ...
            if weather != 'rain':
                ...
                if dry > 4:
                    weather = 'dry'
            if weather == 'rain':
                happy = random.randrange(-10, 10)
                hppy = happiness - happy
                happiness = hppy
            else:
                happy = random.randrange(-5, 1)
                hppy = happiness - happy
                happiness = hppy 
            clkhr1 = clkhr + 1
            clkhr = clkhr1
                ...
                if mc == 1:
                    while working != 'stop':
                        ...
                        if happiness > 100:
                            happiness = 100
                        if happiness <= 10:
                            t10mc = random.uniform(0.01, 0.50) #carrots priced
                            x10mc = t10mc * 100
                            y10mc = int(x10mc)
                            z10mc = float(y10mc)
                            k10mcpay = z10mc / 100
                            ...
                            t20mc = random.uniform(0.50, 1.00) #carrots priced
                            x20mc = t20mc * 100
                            y20mc = int(x20mc)
                            z20mc = float(y20mc)
                            k20mcpay = z20mc / 100
                            ...
                            t30mc = random.uniform(1.00, 1.50) #carrots priced
                            x30mc = t30mc * 100
                            y30mc = int(x30mc)
                            z30mc = float(y30mc)
                            k30mcpay = z30mc / 100
                            ...
                            t40mc = random.uniform(1.50, 2.00) #carrots priced
                            x40mc = t40mc * 100
                            y40mc = int(x40mc)
                            z40mc = float(y40mc)
                            k40mcpay = z40mc / 100
                            ...
                            t50mc = random.uniform(2.00, 2.50) #carrots priced
                            x50mc = t50mc * 100
                            y50mc = int(x50mc)
                            z50mc = float(y50mc)
                            k50mcpay = z50mc / 100
                            ...
                            t60mc = random.uniform(2.50, 3.00) #carrots priced
                            x60mc = t60mc * 100
                            y60mc = int(x60mc)
                            z60mc = float(y60mc)
                            k60mcpay = z60mc / 100
                            ...
                            t70mc = random.uniform(3.00, 3.50) #carrots priced
                            x70mc = t70mc * 100
                            y70mc = int(x70mc)
                            z70mc = float(y70mc)
                            k70mcpay = z70mc / 100
                            ...
                            t80mc = random.uniform(3.50, 4.00) #carrots priced
                            x80mc = t80mc * 100
                            y80mc = int(x80mc)
                            z80mc = float(y80mc)
                            k80mcpay = z80mc / 100
                            ...
                            t90mc = random.uniform(4.00, 7.49) #carrots priced
                            x90mc = t90mc * 100
                            y90mc = int(x90mc)
                            z90mc = float(y90mc)
                            k90mcpay = z90mc / 100
                    ...
                    while working != 'stop':
                        ...
                        if happiness > 100:
                            happiness = 100
                        if happiness <= 10:
                            t10mc = random.uniform(0.01, 1.00) #carrots priced
                            x10mc = t10mc * 100
                            y10mc = int(x10mc)
                            z10mc = float(y10mc)
                            k10mcpay = z10mc / 100
                            ...
                            t20mc = random.uniform(1.00, 2.00) #carrots priced
                            x20mc = t20mc * 100
                            y20mc = int(x20mc)
                            z20mc = float(y20mc)
                            k20mcpay = z20mc / 100
                            ...
                            t30mc = random.uniform(2.00, 3.00) #carrots priced
                            x30mc = t30mc * 100
                            y30mc = int(x30mc)
                            z30mc = float(y30mc)
                            k30mcpay = z30mc / 100
                            ...
                            t40mc = random.uniform(3.00, 4.00) #carrots priced
                            x40mc = t40mc * 100
                            y40mc = int(x40mc)
                            z40mc = float(y40mc)
                            k40mcpay = z40mc / 100
                            ...
                            t50mc = random.uniform(4.00, 5.00) #carrots priced
                            x50mc = t50mc * 100
                            y50mc = int(x50mc)
                            z50mc = float(y50mc)
                            k50mcpay = z50mc / 100
                            ...
                            t60mc = random.uniform(5.00, 6.00) #carrots priced
                            x60mc = t60mc * 100
                            y60mc = int(x60mc)
                            z60mc = float(y60mc)
                            k60mcpay = z60mc / 100
                            ...
                            t70mc = random.uniform(6.00, 7.00) #carrots priced
                            x70mc = t70mc * 100
                            y70mc = int(x70mc)
                            z70mc = float(y70mc)
                            k70mcpay = z70mc / 100
                            ...
                            t80mc = random.uniform(7.00, 8.00) #carrots priced
                            x80mc = t80mc * 100
                            y80mc = int(x80mc)
                            z80mc = float(y80mc)
                            k80mcpay = z80mc / 100
                            ...
                            t90mc = random.uniform(8.00, 9.00) #carrots priced
                            x90mc = t90mc * 100
                            y90mc = int(x90mc)
                            z90mc = float(y90mc)
                            k90mcpay = z90mc / 100
